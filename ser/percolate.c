...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    int oc;
    while((oc = getopt(argc, argv, "l:r:s:p:")) != -1){
        switch(oc){
            case 'l': //set length
                L = atoi(optarg);
                M = L;
    ...
    */
    ...
    // percwrite("sermap.pgm", map, 5);
    percwritedynamic(pgmfile, map, L, 5);
